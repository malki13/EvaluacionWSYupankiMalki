...
a persistence unit "EvaluacionWSYupankiMalkiPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSYupankiMalki\pom.xml":
...
artifact ("EvaluacionWSYupankiMalki.war") is already built. You can build
